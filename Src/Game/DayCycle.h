...
private:
	...
	// 0 sunrise, 0.25 noon, 0.5 sunset, 0.75 midnight. Starts at noon.
    ...
    void refresh() {
        // Compress the daylight half of the sine into the day and stuff the night into the rest.
