...
#endif
	this->create(sf::VideoMode{ SCREEN_WIDTH, SCREEN_HEIGHT }, "VoxLord", sf::Style::Default, settings);

	// Sync to the display refresh so we don't hammer out hundreds of uncapped frames.
